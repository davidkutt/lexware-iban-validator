                        ...
                        >
                            <div className="flex items-center space-x-3">
                                <div className="p-2 bg-white bg-opacity-20 rounded-full">
                                    <Icon name={result.valid ? 'check' : 'close'} className={result.valid ? "text-green-600" : "text-red-600"}
                                          size={24}/>
                                </div>
                            ...
                            {result.valid ? (
                                <div className="space-y-6">
                                    <div className="grid md:grid-cols-2 gap-4">
                                        ...
                                        <InfoField label="Land" value={<Badge variant="primary"
                                                                              rounded>{result.countryCode}</Badge>}/>
